...
* He lived in the city of Syracuse and is said to have a hunger for knowledge and helped the Greek kings in the wars. 
...
* And we would definitely know the Archimedes principle for buoyancy of submerged bodies with which the infamous Eureka story. 
  
* The king of Syracuse had given Archimedes with the task of finding if the crown made by the goldsmith was indeed made of pure gold or it was adulterated with silver. 
  
* We all might have heard of the story that he figured this out with buoyancy when he was taking his bath and ran across the streets of Syracuse shouting Eureka! 
  
* but actually to see how he did it will take another video to explain, so let's move on.

`works on geometry`

* As an engineer, I have heard of the Archimedes principle in the context of fluid statics but what we might not know is that he was a great geometrician. 
...
* The way we choose this point is by taking the line segment closing the parabola and seeing which point on the parabola has a tangent parallel to the line segment that is closing the parabola. 
...
* First,
  ...
  * then we will construct a line that is tangent to the parabola from the end C and from the other end A 
  * we draw a line parallel to the axis of the parabola which will meet the tangent line at F, 
...
I think until this point anyone could've done but what he does next is probably only what Archimedes might've done. 
...
* I would like to say that this is where his engineering comes into play and now he moves on to harness infinity.
...
* To see this better, for illustration, let us consider an isoceles triangle with the same area and same height as triangle ACF, 
